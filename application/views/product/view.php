  ...
  <?php if($post['image'] != null){ ?>
       <div align=center><img src="http://bisnis.financialsecurity.id/assets/products/<?php echo $post['image']; ?>" ></div>
      <?php } ?>
</div><br>
...
<?php
   $slug1      = $this->uri->segment(2); 
     if($slug1 != "view") {$ins = "/".$slug1;}else{ $ins= null;}
?>
                <div class="margin-bottom" id="list8">
		  <div class="head-list"><h3>Services</h3></div>
		  <ul>
                   <li><a href="http://produk.financialsecurity.id/productpage<?=$ins?>/aj"><h4>Asuransi Jiwa</h4></a></li>
                    <li><a href="http://produk.financialsecurity.id/productpage<?=$ins?>/ak"><h4>Asuransi Kesehatan</h4></a></li>
