    ...
    <main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
            <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1">Benefit</h1>
            <p class="margin-bottom-0 text-size-16">Kenali berbagai keuntungan dari produk kami dan temukan yang sesuai bagi anda.<br>
		...
		$i = 1;
              ...
              ?>
              <a href="<?php echo site_url('/benefit/'.$user.'/'.$section.'/'.$post['slug']); ?>">
              <div class="s-12 m-6 l-4 padding">
                <div class="image-with-hover-overlay margin-bottom border-articles">
				 ...
				 <div align=center><img src="http://bisnis.financialsecurity.id/assets/posts/<?php echo $post['image']; ?>" width="16px"></div>
