                ...
                <?php 
                  ...
                  $slug2  = $this->uri->segment(2); 
                   ...
                   if($slug1 == "about" AND $slug2 != "") {
                    ...
                    }elseif($slug1 == "contacts" OR $slug1 == "sdetail" OR $slug1 == "products" OR $slug1 == "gallery" OR $slug1 == "about" OR $slug1 == "products" OR  $slug1 == "forgot" OR $slug1 == "signin" OR $slug1 == "signup") {
                      $pages = base_url()."products";
                    }else{
                      $pages = base_url()."products/".$slug1;
                    }
                    echo $pages;
                  ?>
                ">Products
                  ...
                  $slug3  = $this->uri->segment(3); 
                    if($slug1 == "about" AND $slug2 != "") {
                     ...
                     $pages = base_url()."productpage/".$slug2."/arj";
                      ...
                      $pages = base_url()."productpage/".$slug1."/arj";
                    }
                    echo $pages;
                  ?>">
                Asuransi Rawat Jalan</a></li>
                <li><a href="<?php 
                  $slug1  = $this->uri->segment(1); 
                  $slug2  = $this->uri->segment(2); 
                  $slug3  = $this->uri->segment(3); 
                    if($slug1 == "about" AND $slug2 != "") {
                     ...
                     $pages = base_url()."productpage/".$slug2."/am";
                      ...
                      $pages = base_url()."productpage/".$slug1."/am";
                    }
                    echo $pages;
                  ?>">
                Asuransi Melahirkan</a></li>
                <li><a href="<?php 
                  $slug1  = $this->uri->segment(1); 
                  $slug2  = $this->uri->segment(2); 
                  $slug3  = $this->uri->segment(3); 
